      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <div className="hidden lg:flex items-center justify-between p-4 bg-gradient-to-b from-indigo-50/90 to-slate-50/90 border-b border-slate-200">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-2xl font-semibold text-slate-800">SQL Editor</h1>
              <p className="text-sm text-slate-600">Write and execute SQL queries</p>
            </div>
          </div>
          <div className="flex items-center gap-3">
            <button
              onClick={() => setShowHistory(!showHistory)}
              className="flex items-center gap-2 px-3 py-2 text-slate-600 border border-slate-300 rounded-lg hover:bg-slate-50 transition-colors"
            >
              <History size={16} />
              History
            </button>
