          ...
          {loadingDataSources ? (
            ...
            <>
              ...
              <div className="bg-slate-50 px-6 py-4 border-b border-slate-200">
                  <h2 className="animate__animated animate__slideInLeft text-lg font-semibold text-gray-900 mb-1">
                    Data Sources ({dataSources.length})
                  </h2>
                  <p className="animate__animated animate__slideInLeft animate__delay-1 text-sm text-gray-600 mt-1">
